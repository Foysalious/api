...
<div class="background">
                    ...
                    <table>
                        <tr>
                            <td style="align-items: center;">
                                ...
                                <span style="padding-bottom: 10px">  </span>  <img style="height: 32px;" src="https://cdn-shebaxyz.s3.ap-south-1.amazonaws.com/partner/loans/robi-logo.png" alt="">
                            </td>
                        </tr>
                    </table>
                    <table>
    ...
    <div class="static-node">Note : This applicant has already agreed for the terms and condition (Including providing authorization robi to share info, CIB report)</div>
                    ...
                    <div class="inner-div">
                        ...
                        <table>
                            <tr>
                                ...
                                <th style="width: 60%"><div class="form-control" >{{$final_information_for_loan['business']['trade_license_issue_date']}}</div></th>
                            </tr>
                        </table>
                        <table>
                            <tr>
                                <th style="width: 35%;padding-top: 5px;;">Date of trade license registration</th>
                                <th style="width: 60%"><div class="form-control" > no data</div></th>
                            </tr>
                        </table>
                        <table>
                            <tr>
                                <th style="width: 35%;padding-top: 5px;;">bKash number</th>
                                <th style="width: 60%"><div class="form-control" >{{$final_information_for_loan['finance']['bkash']['bkash_no']}}</div></th>
                            </tr>
                        </table>
                        <table>
                            <tr>
                    ...
                    <div class="inner-div" style="margin-top: 5px">
                        ...
                        <table>
                            <tr>
                                ...
                                <th style="width: 60%"><div class="form-control" >{{$final_information_for_loan['business']['business_additional_information']['address']['street']}}</div></th>
                            </tr>
                        </table>
                        <table>
                            <tr>
                                <th style="width: 35%;padding-top: 5px;;">Post Code</th>
                                <th style="width: 60%"><div class="form-control" >{{$final_information_for_loan['business']['business_additional_information']['address']['post_code']}}</div></th>
                            </tr>
                        </table>
                        <table>
                            <tr>
                                <th style="width: 35%;padding-top: 5px;;">Thana/Upzilla</th>
                                <th style="width: 60%"><div class="form-control" >{{$final_information_for_loan['business']['business_additional_information']['address']['thana']}}</div></th>
                            </tr>
                        </table>
                        <table>
                            <tr>
                                <th style="width: 35%;padding-top: 5px;;">Zilla</th>
                                <th style="width: 60%"><div class="form-control" >{{$final_information_for_loan['business']['business_additional_information']['address']['zilla']}}</div></th>
                            </tr>
                        </table>
                    </div>
                </th>
            ...
            <tr>
                ...
                <td width="16.66%">
                    <div class="inner-div">
                        <table>
                            <tr style="text-align: center">
                                <div class="form-control">Feb</div>
                            </tr>
                        </table>
                    </div>
                </td>
                <td width="16.66%">
                    <div class="inner-div">
                        <table>
                            <tr style="text-align: center">
                                <div class="form-control">Mar</div>
                            </tr>
                        </table>
                    </div>
                </td>
                <td width="16.66%">
                    <div class="inner-div">
                        <table>
                            <tr style="text-align: center">
                                <div class="form-control">Apr</div>
                            </tr>
                        </table>
                    </div>
                </td>
                <td width="16.66%">
                    <div class="inner-div">
                        <table>
                            <tr style="text-align: center">
                                <div class="form-control">May</div>
                            </tr>
                        </table>
                    </div>
                </td>
                <td width="16.66%">
                    <div class="inner-div">
                        <table>
                            <tr style="text-align: center">
                                <div class="form-control">Jun</div>
                            </tr>
                        </table>
                    </div>
                </td>
    ...
    <div class="rules" style="margin-top: 20px">
        <table class="margin-top-10" width="100%">
            ...
            <tr>
                ...
                <td style="text-align: center">যদি এককালীন বিতরণ না হয়, তবে কয়টি কিস্তিতে এবং কী পরিমাণে তা বিতরণ করা হবে?</td>
                <td style="text-align: center"></td>
                <td style="text-align: center">আইপিডিসি'র মন্তব্যের সাথে একমত</td>
            </tr>
            ...
            <tr>
                ...
                <td style="text-align: center">কতো বছরে ঋণ পরিশোধ হবে? (পুনঃতফসিলকৃত হিসেবের জন্য পুনঃতফসিলকরণের পর হতে)</td>
                <td style="text-align: center"></td>
                <td style="text-align: center">আইপিডিসি'র মন্তব্যের সাথে একমত</td>
            </tr>
            ...
            <tr>
                ...
                <td style="text-align: center">না থাকলে, গ্রাহককে সম্পূর্ণ পরিশোধ সূচি সম্পর্কে অবহিত করা হয়েছে কিনা?</td>
                <td style="text-align: center"></td>
                <td style="text-align: center">আইপিডিসি'র মন্তব্যের সাথে একমত</td>
            </tr>
            <tr>
            ...
            <tr>
                <td style="text-align: center"></td>
                <td style="text-align: center">যদি কোন ফী বা চার্জ আদায় করা হয়, তবে কোন পরিস্থিতিতে এবং কি পরিমাণের তা আদায় করা হবে?</td>
                <td style="text-align: center"></td>
                <td style="text-align: center">আইপিডিসি'র মন্তব্যের সাথে একমত</td>
            </tr>
            <tr>
                <td style="text-align: center">১০ (ক)</td>
                <td style="text-align: center">ঋণ হিসাব টি মেয়াদপূর্তির পূর্বে সমন্বয় করা হলে কোন জরিমানা  প্রদান  করতে হবে কী না? </td>
                <td style="text-align: center"></td>
                <td style="text-align: center">আইপিডিসি'র মন্তব্যের সাথে একমত</td>
            </tr>
            <tr>
