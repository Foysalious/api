                ...
                <table style="border-bottom: 1px solid #ddd;width: 100%;color: #929292" cellspacing="5">
                    ...
                    @foreach($pos_order['items'] as $item)
                        <tr>
                            ...
                            <td align="right" style="color: #383d46"><span style="width: 13px">
                                    @include('reports.pdfs.taka_sign')
                                </span>  {{number_format($total,2)}}</td>
                        </tr>
                    @endforeach
                    <tr>
                        <td style="border-top-color: #9b9d9b;border-top-width: 1px ;border-top-style: solid;mso-border-top-width-alt: 1px;color: #9b9b9b"
                            bordercolor="#9b9d9b" colspan="3" align="right">Total
                        </td>
                        <td style="border-top-color: #9b9d9b;border-top-width: 1px ;border-top-style: solid;mso-border-top-width-alt: 1px;color: #383d46"
                            bordercolor="#9b9d9b" align="right">
                            <span style="width: 11px">
                                    @include('reports.pdfs.taka_sign')
                                </span>  {{number_format($pos_order['total'],2)}}</td>
                    </tr>
                    <tr>
                        <td colspan="3" align="right" style="color: #9b9b9b">Total Vat</td>
                        <td align="right" style="color: #383d46"><span style="width: 13px">
                                    @include('reports.pdfs.taka_sign')
                                </span>  {{number_format($pos_order['vat'],2)}}</td>
                    </tr>
                    <tr>
                        <td colspan="3" align="right" style="color: #9b9b9b">Total Discount</td>
                        <td align="right" style="color: #383d46"><span style="width: 13px">
                                    @include('reports.pdfs.taka_sign')
                                </span>  {{number_format($pos_order['discount'],2)}}</td>
                    </tr>
                    <tr>
                        <td colspan="3" align="right" style="color: #9b9b9b">Total Payable</td>
                        <td align="right" style="color: #383d46"><span style="width: 13px">
                                    @include('reports.pdfs.taka_sign')
                                </span>  {{number_format($pos_order['grand_total'],2)}}</td>
                    </tr>
                    <tr>
                        <td colspan="3" align="right" style="color: #9b9b9b">Paid</td>
                        <td align="right" style="color: #383d46"><span style="width: 13px">
                                    @include('reports.pdfs.taka_sign')
                                </span>  {{number_format($pos_order['paid'],2)}}</td>
                    </tr>
                    <tr>
                        <td colspan="3" align="right" style="color: #9b9b9b">Due</td>
                        <td align="right" style="color: #383d46"><span style="width: 13px">
                                    @include('reports.pdfs.taka_sign')
                                </span>  {{number_format($pos_order['due'],2)}}</td>
                    </tr>
                    </tbody>
                </table>
            </td>
