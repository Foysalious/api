...
<table class="" style="width: 100%; margin-bottom: 20px">
    ...
    <tr style="border: 0px">
        <td class="table1th" style="padding: 20px 20px 4px 20px;  opacity: 0.6">Labels</td>
        <td class="table1th" style="padding: 20px 20px 4px 20px;  opacity: 0.6">Delivery Date</td>
        <td class="table1th" style="padding: 20px 20px 4px 20px;  opacity: 0.6">Payment Method</td>
    </tr>
    <tr>
