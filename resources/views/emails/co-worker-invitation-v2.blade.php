                    ...
                    <tr>
                        <td align="center">
                            <table class="es-content-body" style="background-color: transparent" width="600" cellspacing="0" cellpadding="0" bgcolor="transparent" align="center">
                                <tr>
                                    <td class="es-p15t es-p15b es-p20r es-p20l" style="background-position: center bottom" align="left">
                                        ...
                                        <table width="100%" cellspacing="0" cellpadding="0">
                                            <tr>
                                                <td width="600" valign="top" align="center">
                                                    <table style="background-position: center bottom;background-color: #ffffff;border-radius: 5px;border-collapse: separate" width="100%" cellspacing="0" cellpadding="0" bgcolor="#ffffff" role="presentation">
                                                        <tr>
                                                            <td align="center" style="font-size:0">
                                                                <table border="0" width="100%" cellpadding="0" cellspacing="0" role="presentation">
                                                                    <tr>
                                                                        <td style="border-bottom: 5px solid #437ff5;background: none;height: 1px;width: 100%;margin: 0px"></td>
                                                                    </tr>
                                                                </table></td>
                                                        </tr>
                                                        <tr>
                                                            <td align="left" class="es-p30t es-p5r es-p20l" style="font-size: 0px">
                                                                <img class="adapt-img" src="https://business.sheba.xyz/assets/img/statics/sBusiness.png" alt style="display: block" width="180" height="36" layout="responsive">
                                                            </td>
                                                        </tr>
                                                        <tr>
                                            ...
                                            <tr>
                                                <td width="560" align="center" valign="top">
                                                    <table cellpadding="0" cellspacing="0" width="100%" role="presentation">
                                                        <tr>
                                                            <td align="center" class="es-p15b"><h3 style="line-height: 120%">POWERED BY</h3></td>
                                                        </tr>
                                                        <tr>
                                                            <td align="center" style="font-size: 0px">
                                                                <img class="adapt-img" src="https://business.sheba.xyz/assets/img/statics/ShebaXyz.png" alt style="display: block" width="160" height="45" layout="responsive">
                                                            </td>
                                                        </tr>
                                                    </table></td>
                                            </tr>
                    ...
                    <tr>
                        <td align="center">
                            <table class="es-footer-body" style="background-color: transparent" width="600" cellspacing="0" cellpadding="0" bgcolor="rgba(0, 0, 0, 0)" align="center">
                                <tr>
                                    <td class="es-p5t es-p20b es-p20r es-p20l" style="background-color: transparent" bgcolor="transparent" align="left">
