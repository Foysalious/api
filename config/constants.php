...
return [
    ...
    'COMPLAIN_CATEGORIES' => [
        ...
        'Technical' => ['Within Warranty Period', 'After Warranty Period', 'Another Parts']
    ],
    ...
    'SALES_CHANNELS' => [
        'Call-Center'   => ['name' => 'Call-Center', 'prefix' => 'D', 'department' => 'SD'],
        'Web'           => ['name' => 'Web', 'prefix' => 'D', 'department' => 'SD'],
        'Facebook'      => ['name' => 'Facebook', 'prefix' => 'D', 'department' => 'SD'],
        'B2B'           => ['name' => 'B2B', 'prefix' => 'F', 'department' => 'FM'],
        'Store'         => ['name' => 'Store', 'prefix' => 'S', 'department' => 'SM'],
        'Alternative'   => ['name' => 'Alternative', 'prefix' => 'A', 'department' => 'AC'],
        'Affiliation'   => ['name' => 'Affiliation', 'prefix' => 'A', 'department' => 'AC'],
    ],
    'SERVICE_UNITS' => ['ft', 'sft', 'hour', 'kg', 'meal', 'person', 'piece', 'rft', 'seat', 'strip'],
    'FEEDBACK_STATUSES' => [
        'Open'          => 'Open',
        'Acknowledged'  => 'Acknowledged',
        'In_Process'    => 'In Process',
