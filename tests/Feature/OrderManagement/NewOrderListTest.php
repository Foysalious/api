...
class NewOrderListTest extends FeatureTestCase
{
    ...
    */
    ...
    {
        $response = $this->get(
            "/v1/partners/".$this->partner->id."/order-requests?remember_token=".$this->resource->remember_token
        );
    ...
    {
        $response = $this->get(
            "/v1/partners/".$this->partner->id."/order-requests?remember_token=".$this->resource->remember_token."&filter=invalid"
        );
        $data = $response->decodeResponseJson();
        $this->assertEquals(400, $data['code']);
    ...
    {
        $response = $this->get(
            "/v1/partners/".$this->partner->id."/order-requests?remember_token=i3zuho3Tw1TxaRC7LIB5Py8KaT9mRtxffv1H1lqZu13rTNUHCXrhxD2h2Nor&limit=200&offset=0&filter=all"
        );
        $data = $response->decodeResponseJson();
    ...
    public function testEmptyOrderListResponseCode()
    {
        ...
        $response = $this->get(
            "/v1/partners/".$this->partner->id."/order-requests?remember_token=".$this->resource->remember_token."&filter=all"
        );
        $data = $response->decodeResponseJson();
