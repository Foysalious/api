...
class sProOrderCreateServiceTest extends FeatureTestCase
{
    ...
    public function setUp(): void
    {
        ...
        DB::insert(
            'insert into partner_service(partner_id,service_id, created_by, created_by_name, updated_by, updated_by_name) values (?, ?, ?, ?, ?, ?)',
            [1, 1, 1, 'IT - Shafiqul Islam', 1, 'IT - Shafiqul Islam']);
    }
    ...
    public function testSProServiceAPIWithValidLatLng()
    {
        ...
        //act
        $response = $this->get(
            '/v2/resources/partner/categories/'.$this->secondaryCategory->id.'/services?lat=23.788099544655&lng=90.412001016086',
            [
    ...
    public function testSProServiceAPIWithLatFieldAndWithoutLngField()
    {
        ...
        //act
        $response = $this->get(
            '/v2/resources/partner/categories/'.$this->secondaryCategory->id.'/services?lat=23.788099544655', [
                'Authorization' => "Bearer $this->token",
            ]);
    ...
    public function testSProServiceAPIWithoutLatFieldAndWithLngField()
    {
        ...
        //act
        $response = $this->get(
            '/v2/resources/partner/categories/'.$this->secondaryCategory->id.'/services?lng=90.412001016086', [
                'Authorization' => "Bearer $this->token",
            ]);
    ...
    public function testSProServiceAPIWithInvalidAlphabeticCharacterLatLng()
    {
        ...
        //act
        $response = $this->get(
            '/v2/resources/partner/categories/'.$this->secondaryCategory->id.'/services?lat=abcde&lng=abcde', [
                'Authorization' => "Bearer $this->token",
            ]);
    ...
    public function testSProServiceAPIWithInvalidSpecialCharacterLatLng()
    {
        ...
        //act
        $response = $this->get(
            '/v2/resources/partner/categories/'.$this->secondaryCategory->id.'/services?lat=!@#$%^*&lng=!@#$%^*', [
                'Authorization' => "Bearer $this->token",
            ]);
    ...
    public function testSProServiceAPIWithInvalidSpecialCharacterLatAndValidLng()
    {
        ...
        //act
        $response = $this->get(
            '/v2/resources/partner/categories/'.$this->secondaryCategory->id.'/services?lat=!@#$%^*&lng=90.412001016086',
            [
                'Authorization' => "Bearer $this->token",
            ]);
    ...
    public function testSProServiceAPIWithInvalidAlphabeticCharacterLatAndValidLng()
    {
        ...
        //act
        $response = $this->get(
            '/v2/resources/partner/categories/'.$this->secondaryCategory->id.'/services?lat=abcde&lng=90.412001016086',
            [
                'Authorization' => "Bearer $this->token",
            ]);
    ...
    public function testSProServiceAPIWithValidLatAndInvalidAlphabeticCharacterLng()
    {
        ...
        //act
        $response = $this->get(
            '/v2/resources/partner/categories/'.$this->secondaryCategory->id.'/services?lat=23.788099544655&lng=abcde',
            [
                'Authorization' => "Bearer $this->token",
            ]);
    ...
    public function testSProServiceAPIWithValidLatAndInvalidSpecialCharacterLng()
    {
        ...
        //act
        $response = $this->get(
            '/v2/resources/partner/categories/'.$this->secondaryCategory->id.'/services?lat=23.788099544655&lng=!@#$%^*',
            [
                'Authorization' => "Bearer $this->token",
            ]);
