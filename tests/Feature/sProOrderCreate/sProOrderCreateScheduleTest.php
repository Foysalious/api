...
class sProOrderCreateScheduleTest extends FeatureTestCase
{
    ...
    public function testSProScheduleAPIWithValidCategoryIdPartnerIdDateTime()
    {
        ...
        //act
        $response = $this->get(
            '/v2/resources/schedules/check?category='.$this->secondaryCategory->id.'&partner='.$this->partner->id.'&date='.$this->today.'&time=15:00:00-16:00:00',
            [
    ...
    public function testSProScheduleAPIWithNoCategoryId()
    {
        ...
        //act
        $response = $this->get(
            '/v2/resources/schedules/check?partner='.$this->partner->id.'&date='.$this->today.'&time=15:00:00-16:00:00',
            [
                'Authorization' => "Bearer $this->token",
            ]);
    ...
    public function testSProScheduleAPIWithInvalidCharacterCategoryId()
    {
        ...
        //act
        $response = $this->get(
            '/v2/resources/schedules/check?category=abcde&partner='.$this->partner->id.'&date='.$this->today.'&time=15:00:00-16:00:00',
            [
                'Authorization' => "Bearer $this->token",
            ]);
    ...
    public function testSProScheduleAPIWithNoPartnerId()
    {
        ...
        //act
        $response = $this->get(
            '/v2/resources/schedules/check?category='.$this->secondaryCategory->id.'&date='.$this->today.'&time=15:00:00-16:00:00',
            [
                'Authorization' => "Bearer $this->token",
            ]);
    ...
    public function testSProScheduleAPIWithInvalidPartnerId()
    {
        ...
        //act
        $response = $this->get(
            '/v2/resources/schedules/check?category='.$this->secondaryCategory->id.'&partner=abcde&date='.$this->today.'&time=15:00:00-16:00:00',
            [
                'Authorization' => "Bearer $this->token",
            ]);
    ...
    public function testSProScheduleAPIWithNoDate()
    {
        ...
        //act
        $response = $this->get(
            '/v2/resources/schedules/check?category='.$this->secondaryCategory->id.'&partner='.$this->partner->id.'&time=15:00:00-16:00:00',
            [
                'Authorization' => "Bearer $this->token",
            ]);
    ...
    public function testSProScheduleAPIWithInvalidDate()
    {
        ...
        //act
        $response = $this->get(
            '/v2/resources/schedules/check?category='.$this->secondaryCategory->id.'&partner='.$this->partner->id.'&date=abcde&time=15:00:00-16:00:00',
            [
                'Authorization' => "Bearer $this->token",
            ]);
    ...
    public function testSProScheduleAPIWithNoTime()
    {
        ...
        //act
        $response = $this->get(
            '/v2/resources/schedules/check?category='.$this->secondaryCategory->id.'&partner='.$this->partner->id.'&date='.$this->today,
            [
                'Authorization' => "Bearer $this->token",
            ]);
    ...
    public function testSProScheduleAPIWithInvalidTime()
    {
        ...
        //act
        $response = $this->get(
            '/v2/resources/schedules/check?category='.$this->secondaryCategory->id.'&partner='.$this->partner->id.'&date='.$this->today.'&time=abcde',
            [
                'Authorization' => "Bearer $this->token",
            ]);
