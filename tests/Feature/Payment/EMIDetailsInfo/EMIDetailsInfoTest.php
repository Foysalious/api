...
{
    public function testEMIInfoByGivingNoParameterAmount(Calculator $emi_calculator)
    {
...
//        $this->assertEquals($amount,$data["price"]);
//        $this->assertEquals($emi_data,$data["info"]);
    ...
    public function testEMIInfoByGivingParameterOfFractionalValue()
    {
        ...
        $this->assertEquals(200,$data["code"]);
        $this->assertEquals("Successful",$data["message"]);
        //$this->assertEquals(round($amount),$data["price"]);
