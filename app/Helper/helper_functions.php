    ...
    function timeAgo($time_ago)
    {
        ...
        if ($sec <= 60) {
            ...
            if ($weeks == 1) {
                ...
                return [
                    'en' => "$weeks weeks ago",
                    "bn" => en2bnNumber($weeks) . " সপ্তাহ অগে"
                ];
            }
        } // Check for months
        else if ($mnths <= 12) {
