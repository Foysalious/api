...
class AffiliateTransactionRepository
{
    ...
    private function categoryWiseTransaction()
    {
        ...
        $campaign_reward            = $this->affiliate->transactions()->credit()->RewardForCampaign()->between($this->start_date, $this->end_date);
        ...
        if($count = $campaign_reward->count()) $category_wise_transaction[] = $this->makeData($campaign_reward->sum('amount'), $count, "Reward Point", "পুরষ্কার পয়েন্ট", "reward_point",'+');
