...
class PartnerJobRepository
{
    ...
    {
        return (collect($job_service)->only('id', 'job_id', 'service_id', 'name', 'variable_type', 'variables', 'option', 'additional_info', 'quantity', 'unit_price', 'sheba_contribution', 'partner_contribution'))->toArray();
    }
