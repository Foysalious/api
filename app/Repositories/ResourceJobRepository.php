        ...
        foreach ($jobs as $job) {
            ...
            if (count($job->jobServices) == 0) {
                ...
                foreach ($job->jobServices as $jobService) {
                    ...
                    $services->push(array('name' => $jobService->formatServiceName(), 'variables' => $variables, 'unit' => $jobService->service ? $jobService->service->unit : null, 'quantity' => $jobService->quantity));
                }
            }
