...
//                                $job->service_variables = $service_variables = json_encode($service->service->variables);
    ...
    private function createOrder($order, $order_info)
    {
        ...
        $order->info_call_id = isset($order_info['info_call_id']) ? $order_info['info_call_id'] : null;
        $order->affiliation_id = isset($order_info['affiliation_id']) ? $order_info['affiliation_id'] : null;
