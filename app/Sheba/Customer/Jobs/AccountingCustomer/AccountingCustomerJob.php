...
class AccountingCustomerJob extends Job implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        $service->setPartnerId($this->event->partner_id)->setCustomerId($this->event->id)->setCustomerMobile($this->event->mobile)->setCustomerName($this->event->customer->name)->storeAccountingCustomer();
    }
}
