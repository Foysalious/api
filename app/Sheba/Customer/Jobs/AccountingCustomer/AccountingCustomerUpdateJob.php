...
class AccountingCustomerUpdateJob extends Job implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        $service->setPartnerId($this->event->getCustomerPartnerID())->setCustomerId($this->event->getCustomerId())->setCustomerMobile($this->event->getCustomerMobile())->setCustomerName($this->event->getCustomerName())->updateAccountingCustomer();
    }
}
