...
class AccountCreate
{
    ...
    private function makeApplicationData($application)
    {
        ...
        $data = [
            ...
            "account_title" => substr($account_title, 0, 35),
            ...
            "father"        => isset($application['personal']['father_name']) ? substr($this->removeSpecialCharacters($application['personal']['father_name']),0,35) : null,
            "mother"        => isset($application['personal']['mother_name']) ? substr($this->removeSpecialCharacters($application['personal']['mother_name']), 0, 35) : null,
            ...
            "nid"           => isset($application['nid_selfie']['nid_no']) ? substr($application['nid_selfie']['nid_no'],0,35) : null,
            ...
            "town"          => isset($application['personal']['present_address']["district_present_address"]) ? substr($application['personal']['present_address']["district_present_address"],0,35) : null,
            "post_code"     => isset($application['personal']['present_address']['postcode_present_address']) ? substr($application['personal']['present_address']['postcode_present_address'],0,35) : '',
            "mobile_no"     => substr($this->mobile,0,14),
