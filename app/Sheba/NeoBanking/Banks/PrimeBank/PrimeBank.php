...
class PrimeBank extends Bank
{
    ...
    {
        $data = [
            'header' => '<h3>আমি ঘোষণা করছি যে :</h3>',
            'body' => '<p>১. আমি যে ব্যবসার জন্য প্রাইম ব্যাংক লিমিটেডে অ্যাকাউন্ট খোলার জন্য আবেদন করছি তার "একমাত্র-স্বত্বাধিকারী"
                    আমি নিজে ।</p>
                    <p>২. এই আবেদনপত্রটির সাথে প্রদত্ত সমস্ত তথ্য সত্য।</p>
                    <p>৩. আমি ব্যাংকের চাহিদামাফিক প্রয়োজনীয় তথ্য/নথি সরবরাহ করব।</p>
                    <p>৪. আমি ব্যাংকে যে তথ্য সরবরাহ করেছি তাতে যদি কোনো পরিবর্তন ঘটে তবে আমি ৩০ (ত্রিশ) ক্যালেন্ডার দিনের
                    মধ্যে ব্যাংকে অবহিত করার উদ্যোগ নিবো।</p>
                    <P>৫. আমি প্রাইম ব্যাংক লিমিটেড এর এসএমএস পরিষেবাতে নিবন্ধন করতে সম্মত হয়েছি যার জন্য অমি আমার ঘোষিত মোবাইল 
                    নম্বরে ব্যাংক লেনদেনের তথ্য সহ অন্যান্য সকল তথ্য পেতে আগ্রহী।</P>
                    <p>৬. আমি সম্মতি প্রকাশ করছি যে , যে শর্তাবলী ব্যাংকের বিবেচনার ভিত্তিতে পর্যালোচনা এবং পরিবর্তন যোগ্য; এবং
                    কোনো পরিবর্তন যদি হয় তা গ্রাহকের ক্ষেত্রে ও সমানভাবে প্রযোজ্য হবে । উপরে উল্লিখিত পাঠ্যের বাংলা ও ইংরেজী
                    সংস্করণের মধ্যে যদি কোনো বিভ্রান্তি দেখা দেয় তবে ইংরেজি সংস্করণটি সঠিক হিসাবে গণ্য হবে ।</p>',
            'agreement' => '<b>আমি প্রাইম  ব্যাংকের <u>শর্তে</u> রাজি।</b>'
            ];
        try {
            return  $data;
        } catch (\Throwable $e) {
