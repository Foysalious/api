...
class Completion
{
    ...
    public function setApply($completion)
    {
        ...
        if (!isset($this->gigatech_data->data->data->status)) $this->can_apply = 0;
    }
