...
class Creator
{
    ...
    private function format()
    {
        ...
        $this->data['warranty_unit'] = (isset($this->data['warranty_unit']) && in_array($this->data['warranty_unit'], config('pos.warranty_unit'))) ? $this->data['warranty_unit'] : config('pos.warranty_unit.day.en');
    }
