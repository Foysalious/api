...
class MonthlyStat
{
    ...
    public function transform($attendances)
    {
        ...
        $statistics = [
            'working_days' => $this->timeFrame->start->format('Y-m') === Carbon::now()->format('Y-m') ? $this->timeFrame->start->daysInMonth : $this->timeFrame->start->diffInDays($this->timeFrame->end) + 1,
            Statuses::ON_TIME => 0,
            Statuses::LATE => 0,
