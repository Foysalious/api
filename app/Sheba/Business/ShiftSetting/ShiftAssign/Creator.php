...
class Creator
{
    ...
    private function makeData()
    {
        return [
            ...
            'checkin_grace_enable' => $this->shiftCalenderRequester->getIsCheckinGraceTimeEnabled(),
            'checkin_grace_time' => $this->shiftCalenderRequester->getCheckinGraceTime(),
            'checkout_grace_enable' => $this->shiftCalenderRequester->getIsCheckoutGraceTimeEnabled(),
