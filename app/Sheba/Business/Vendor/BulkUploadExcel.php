...
class BulkUploadExcel
{
    const SHEET = "data";

    const VEHICLE_TYPE_COLUMN = "A";
    const VEHICLE_BRAND_NAME_COLUMN = "B";
    const MODEL_NAME_COLUMN = "C";
    const MODEL_YEAR_COLUMN = "D";
    const VEHICLE_DEPARTMENT_COLUMN = "E";
    ...
    const MODEL_NAME_COLUMN_TITLE = "model_name";
    const MODEL_YEAR_COLUMN_TITLE = "model_year";
    const VEHICLE_DEPARTMENT_COLUMN_TITLE = "vehicle_department";
    ...
    const INSURANCE_VALID_TILL_COLUMN_TITLE = "insurance_valid_till";
    const TRANSMISSION_TYPE_COLUMN_TITLE = "transmission_type";
}
