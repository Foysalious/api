...
class PosCustomerService
{
    ...
    public function getDetails(): array
    {
        ...
        $customer_details['customer_since_formatted'] = isset($customer_info['created_at']) ? convertTimezone(Carbon::parse($customer_info['created_at'])->format('Y-m-d H:i:s')): null;
