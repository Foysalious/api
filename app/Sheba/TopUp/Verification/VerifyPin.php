...
class VerifyPin
{
    ...
    {
        if ($this->managerResource && $this->agent instanceof Partner) return $this->managerResource->update($this->withUpdateModificationField(['remember_token' => str_random(255)]));
