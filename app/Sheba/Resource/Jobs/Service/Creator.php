...
class Creator
{
    ...
    public function create()
    {
        foreach ($this->services as $selected_service) {
            ...
            if (!$selected_service->getCategory()->isRentACarOutsideCity() && !$location_service) throw new LocationServiceNotFoundException('Service #' . $service->id . ' is not available at this location #' . $this->order->deliveryAddress->location_id);
