...
//            if ($this->firstJobFromList && $this->shouldICheckActions($this->firstJobFromList, $job))
            $formatted_job = $this->actionCalculator->calculateActionsForThisJob($formatted_job, $job);
