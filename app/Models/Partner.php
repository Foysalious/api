...
class Partner extends Model implements Rewardable, TopUpAgent
{
    ...
    protected $servicePivotColumns = ['id', 'description', 'options', 'prices', 'min_prices', 'min_prices_quantity', 'is_published', 'discount', 'discount_start_date', 'discount_start_date', 'is_verified', 'verification_note', 'created_by', 'created_by_name', 'created_at', 'updated_by', 'updated_by_name', 'updated_at'];
