    ...
    public function transform($approval_request)
    {
        ...
        return [
            ...
            'leave' => [
                ...
                'period' => $requestable->start_date == $requestable->end_date ? $requestable->start_date->format('M d') : $requestable->start_date->format('M d')  . ' - ' . $requestable->end_date->format('M d'),
