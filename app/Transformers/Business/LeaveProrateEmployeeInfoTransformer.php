...
use Sheba\Dal\LeaveType\Contract as LeaveTypeRepository;
...
class LeaveProrateEmployeeInfoTransformer extends TransformerAbstract
{
    ...
    public function __construct()
    {
        ...
        $this->leaveTypeRepository = app(LeaveTypeRepository::class);
    }
    ...
    public function transform($prorate)
    {
        ...
        $leave_type = $this->leaveTypeRepository->findWithTrashed($prorate->leave_type_id);
        return [
            'id' => $prorate->id,
