...
class SendEmailForBiddingTenderToBusiness extends Job implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        Mail::send('emails.tender-bidding', ['business_contract_person' => $business_contract_person, 'vendor_name' => $vendor_name, 'bid_detail' => $bid_detail, 'tender_id' => $tender_id], function ($m) use ($subject, $business_email) {
