        ...
        $api->group(['prefix' => 'pos/v1', 'namespace' => 'App\Http\Controllers'], function ($api) {
            ...
            $api->group(['middleware' => ['jwtAccessToken']], function ($api) {
                ...
                $api->group(['prefix' => 'webstore-banner', 'middleware' => ['jwtAccessToken']], function ($api) {
                    ...
                    $api->get('/{banner}', 'WebstoreSettingController@getBanner');
                    $api->post('/', 'WebstoreSettingController@storeBanner');
                    $api->put('/{banner}', 'WebstoreSettingController@updateBanner');
                });
                ...
                $api->group(['prefix' => 'suppliers'], function ($api) {
                    ...
                    $api->delete('/{supplier_id}', 'PosCustomer\PosCustomerController@deleteSupplier');
                });
                $api->get('contacts', 'PosCustomer\PosCustomerController@contactList');
