    ...
    public function set($api)
    {
        $api->group(['prefix' => 'accounting', 'middleware' => ['accounting.auth']], function ($api) {
            $api->group(['prefix' => 'due-tracker'], function ($api) {
                ...
                $api->put('/{entry_id}', 'Accounting\\DueTrackerControllerV2@update');
                ...
                $api->get('/sms-subscription-check', 'Accounting\\DueTrackerSmsController@checkSmsBalanceAndSubscription');
        ...
        $api->group(['prefix' => 'accounting'], function ($api) {
            $api->group(['prefix' => 'due-tracker'], function ($api) {
                ...
                $api->get('/public-report-download', 'Accounting\\DueTrackerControllerV2@publicReportDownload');
