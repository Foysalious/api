...
class JobController extends Controller
{
    ...
    public function show($customer, $job, Request $request)
    {
        try {
            ...
            $job_collection->put('pick_up_address_geo', $job->carRentalJobDetail ? $job->carRentalJobDetail->pick_up_address_geo : null);
            $job_collection->put('destination_address', $job->carRentalJobDetail ? $job->carRentalJobDetail->destination_address : null);
            $job_collection->put('destination_address_geo', $job->carRentalJobDetail ? $job->carRentalJobDetail->destination_address_geo : null);
