            ...
            $faqs = array(
                ...
                array('group_label_bn' => 'একাউন্ট স্থগিত হবার কারণ কী?', 'group_label_en' => 'THE REASON FOR SUSPENSION OF ACCOUNTS', 'group_name' => 'account_suspension',
                    'questions' => array(
                        ...
                        array('question_bn' => 'আমার একাউন্টটি কতদিন স্থগিত থাকবে?', 'answer_bn' => 'আপনার একাউন্টটি সর্বোচ্চ ৩ দিন স্থগিত থাকতে পারে। তবে নিরাপত্তা জনিত কারণে আপনার একাউন্টটি স্থায়ী ভাবে আপনার বন্ধু একাউন্টটি বন্ধ করে দেওয়া হতে পারে। বিস্তারিত জানতে ১৬৫১৬ অথবা +৮৮০৯৬৭৮০১৬৫১৬ এ কল দিতে পারেন।', 'question_en' => 'How long my account will be suspended ?', 'answer_en' => 'Suspension will go away after 3 days automatically. But your account can be suspended permanently due to security concerns. Please call 16516 or +8809678016516 for further details.'),)
                ),
                ...
                array('group_label_bn' => 'যেকোন ধরণের জিজ্ঞাসা আমি কোথায় করব?', 'group_label_en' => 'General Question', 'group_name' => 'helpline',
                    'questions' => array(
                        array('question_bn' => 'যেকোনো ধরণের জিজ্ঞাসা আমি কোথায় করব?', 'answer_bn' => 'যেকোনো জিজ্ঞাসার জন্য ১৬৫১৬ অথবা +৮৮০৯৬৭৮০১৬৫১৬ এ কল করুন।', 'question_en' => 'Whom to contact if I face any issue with this app?', 'answer_en' => 'Call 16516 or +8809678016516 if you face any difficulties or need any kind of support.'),)),
                array('group_label_bn' => 'টপ-আপ কিভাবে কাজ করে?', 'group_label_en' => 'How TOP-UP works?', 'group_name' => 'TOP-UP', 'questions' => array(
                    array('question_bn' => 'টপ-আপ কিভাবে কাজ করে?', 'answer_bn' => 'বন্ধুতে আপনি যেকোনো মোবাইল অপারেটরে টপ-আপ করার সুযোগ পাচ্ছেন সহজেই। আপনি আপনার বন্ধুর মোবাইলে টপ-আপ করার পাশাপাশি রবি, এয়ারটেল, বাংলালিংকে পাচ্ছেন ২.৫% বোনাস বন্ধু পয়েন্ট এবং গ্রামীনফোন, টেলিটকে পাচ্ছেন ২% বোনাস বন্ধু পয়েন্ট।', 'question_en' => 'How TOP-UP works?', 'answer_en' => 'You can do TopUP/mobile recharge using your Bondhu Point, you will get 2.5 % bonus for Robi, Airtel, Banglalink and 2% for Grameenphone, TeleTalk in your Bondhu balance for every TopUP. '),),),
                );
