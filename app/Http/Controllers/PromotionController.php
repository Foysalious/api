...
class PromotionController extends Controller
{
    ...
    private function calculateOrderAmount(PartnerListRequest $request, $partner)
    {
        ...
        if ($partner_list->hasPartners) {
            ...
            $order_amount = 0;
            $delivery_charge = (new DeliveryCharge())->setCategory($request->selectedCategory)->setPartner($partner)->setCategoryPartnerPivot($partner->categories->first()->pivot)->getDeliveryCharge(); //(double)$category_pivot->delivery_charge;
