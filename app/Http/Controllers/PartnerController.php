...
class PartnerController extends Controller
{
    ...
    public function show($partner, Request $request)
    {
        try {
            ...
            $info->put('banner', $partner->webstoreBanner ? $partner->webstoreBanner->banner->image_link : null);
            $working_info = [];
    ...
    public function changeLeaveStatus($partner, Request $request, LeaveStatus $leaveStatus, UserAgentInformation $userAgentInformation)
    {
        try {
            ...
            $status = $leaveStatus->setArtisan(Partner::find($partner))->setUserAgentInformation($userAgentInformation)->changeStatus()->getCurrentStatus();
